...
INSERT INTO modules (code, name, description) VALUES
    ...
    ('MOD_PRODUCTS',  'Productos e Inventario',   'Catálogo de productos con categorías, precios y control de stock (entradas/salidas/ajustes).'),
    ('MOD_FINANCE',   'Módulo Financiero',        'Registro y seguimiento de egresos operacionales: arriendos, nómina, impuestos, etc.'),
    ('MOD_PARAMS',    'Parámetros del Sistema',   'Gestión de proveedores, impuestos, reportes y auditoría de la empresa.');
