-- =============================================
-- PYMEFLOWEC · ERP MULTITENANT — SCHEMA v9
-- PostgreSQL 15+  |  Schema unificado completo
--
-- Cambios respecto a v8:
--   + companies.invoice_settings JSONB — personalización de factura por tenant
--
-- TABLAS (23):
...
-- Para migrar desde v8: ejecutar migration_add_invoice_settings.sql
-- =============================================
...
COMMENT ON COLUMN invoices.payment_status IS 'Estado de cobro. Recalculado por el backend al registrar invoice_payments.';
...
-- =============================================
-- 16. EXPENSES (cabecera del egreso)
-- =============================================
...
BEGIN
    FOR t IN SELECT unnest(ARRAY[
        ...
        'suppliers','store_customers','tax_rates','products','invoices',
...
BEGIN
    FOR t IN SELECT unnest(ARRAY[
        ...
        'products','invoices','invoice_details','invoice_payments',
...
-- =============================================
-- 23 TABLAS:
--   1.  roles                   8.  store_customers      15. expenses
--   2.  companies               9.  tax_rates            16. expense_payments
--   3.  users                  10.  products             17. expense_budgets
--   4.  modules                11.  invoices             18. expense_recurring
--   5.  company_module_requests 12.  invoice_details     19. petty_cash
--   6.  company_modules         13.  invoice_payments    20. petty_cash_movements
--   7.  suppliers               14.  inventory_movements 21. audit_logs
--                                                        22. system_logs
...
--
-- CAMBIOS v8 → v9:
--   + companies.invoice_settings JSONB NOT NULL DEFAULT '{}'
--     Personalización de factura: display_name, template_id, accent_color, footer_text,
--     establishment (prefijo establecimiento SRI, 3 dígitos), emission_point (punto de emisión SRI, 3 dígitos)
