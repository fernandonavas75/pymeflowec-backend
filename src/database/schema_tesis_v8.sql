-- =============================================
-- PYMEFLOWEC · ERP MULTITENANT — SCHEMA v8
...
CREATE TABLE invoice_payments (
    ...
    transfer_reference VARCHAR(100)  NULL,  -- obligatorio si método=TRANSFERENCIA y status!=PENDIENTE
    card_contrapartida VARCHAR(100)  NULL,  -- obligatorio si método=TARJETA_* y status!=PENDIENTE
